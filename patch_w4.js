...
const comments_orig = `  const [comments, setComments] = useState<Array<{ name: string; attendance: string; message: string; created_at: string }>>([
    {
      name: "Keanu & Anya ⚡",
...
const bgphotos_orig = `        invitationData?.coverPhoto || "/wedding4-hero.jpg",
        "/wedding4-couple1.jpg",
        "/wedding4-couple2.jpg",
        "/wedding4-couple3.jpg"
      ];`;
const bgphotos_new = `        weddingNotes?.heroPhotoUrl || invitationData?.coverPhoto || invitationData?.cover_photo || "/wedding4-hero.jpg",
        "/wedding4-couple1.jpg",
        "/wedding4-couple2.jpg"
      ];
