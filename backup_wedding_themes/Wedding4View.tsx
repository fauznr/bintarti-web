...
export default function Wedding4View({
  ...
  useEffect(() => {
    const targetDate = new Date("2026-08-18T09:00:00").getTime();
        ...
        <div className={`fixed inset-0 z-50 flex flex-col items-center justify-between p-6 bg-slate-900 text-center select-none overflow-hidden transition-all duration-700 ease-in-out ${
          ...
          <div className="absolute inset-0 overflow-hidden">
            <div 
              ...
              style={{ backgroundImage: `url('/wedding4-hero.jpg')` }}
            />
        ...
        <div className="w-full max-w-[430px] mx-auto bg-white min-h-screen shadow-2xl relative border-x border-slate-200 pb-24 overflow-hidden">
          ...
          <section className="px-6 py-8 space-y-8 text-center bg-slate-50/50">
            ...
            <ScrollReveal delay={150}>
              <div className="bg-white rounded-3xl p-5 border border-slate-200 shadow-xl flex flex-col items-center space-y-4 relative">
                ...
                <div className="space-y-1 text-center">
                  <h3 className="text-xl font-adea-forum font-bold text-slate-900 tracking-wider uppercase">Dimas Anggara, S.Kom.</h3>
                  <p className="text-xs font-adea-lora text-slate-500 italic">Putra dari Bapak H. Subagyo &amp; Ibu Hj. Tri Murni</p>
                  <a 
            ...
            <ScrollReveal delay={350}>
              <div className="bg-white rounded-3xl p-5 border border-slate-200 shadow-xl flex flex-col items-center space-y-4 relative">
                ...
                <div className="space-y-1 text-center">
                  <h3 className="text-xl font-adea-forum font-bold text-slate-900 tracking-wider uppercase">Annisa Rahma, S.E.</h3>
                  <p className="text-xs font-adea-lora text-slate-500 italic">Putri dari Bapak Dr. H. Faisal &amp; Ibu Hj. Nuraini</p>
                  <a 
                    href="https://instagram.com" 
                    target="_blank" 
                    rel="noopener noreferrer" 
              ...
              <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-xl space-y-4 text-center relative overflow-hidden">
                ...
                <div className="space-y-2">
                  <div className="flex justify-center items-center gap-2 text-slate-900 text-sm font-extrabold">
                    ...
                    <span>Selasa, 18 Agustus 2026</span>
                  </div>
                  ...
                  <div className="flex justify-center items-center gap-2 text-slate-600 text-xs font-semibold">
                    ...
                    <span>Masjid Ramlie Musofa, Sunter, Jakarta Utara</span>
                  </div>
                </div>

                <a 
                  href="https://maps.google.com/?q=Masjid+Ramlie+Musofa" 
                  target="_blank" 
                  rel="noopener noreferrer"
            ...
            <ScrollReveal delay={300}>
              <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-xl space-y-4 text-center relative overflow-hidden">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-center items-center gap-2 text-slate-600 text-xs font-semibold">
                    <MapPin className="w-4 h-4 text-slate-500" />
                    <span>Glass House Ballroom, Park Hyatt Jakarta</span>
                  </div>
                </div>

                <a 
                  href="https://maps.google.com/?q=Park+Hyatt+Jakarta" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-slate-900 text-white font-black text-xs uppercase tracking-wider shadow-md hover:bg-slate-800 transition-all cursor-pointer"
                >
          ...
          <section className="px-6 py-8 text-center space-y-6 bg-white">
            ...
            <ScrollReveal delay={250}>
              <button
                onClick={() => {
                  const icsData = "BEGIN:VCALENDAR\nVERSION:2.0\nBEGIN:VEVENT\nSUMMARY:Pernikahan Kenzo & Valerie\nLOCATION:Glass House Ballroom, Park Hyatt Jakarta\nEND:VEVENT\nEND:VCALENDAR";
                  const blob = new Blob([icsData], { type: "text/calendar" });
                  const url = URL.createObjectURL(blob);
                  const a = document.createElement("a");
                  a.href = url;
                  a.download = "Pernikahan_Kenzo_Valerie.ics";
                  a.click();
                }}
              ...
              {galleryImages.map((src, idx) => (
                <ScrollReveal key={idx} delay={idx * 80}>
                  <div 
                    ...
                    className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-slate-200 shadow-md group cursor-pointer hover:shadow-xl transition-all"
                  >
                    <Image 
                      src={src} 
                    ...
                    <div className="absolute inset-0 bg-slate-900/30 group-hover:bg-slate-900/10 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100">
                      <span className="text-[10px] font-bold text-slate-900 bg-white/90 px-3 py-1 rounded-full border border-slate-200 shadow-md backdrop-blur-sm">
                        🔍 Perbesar
                      </span>
                    </div>
                  </div>
            ...
            <div className="space-y-3.5 text-left">
              ...
              <ScrollReveal delay={200}>
                <div className="bg-white p-5 rounded-3xl border border-slate-200 text-left space-y-3 shadow-md">
                  <div className="flex justify-between items-center">
                    <span className="font-black text-sm text-slate-900">BANK BCA</span>
                    <span className="text-[10px] font-extrabold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full">VERIFIED</span>
                  </div>
                  <div>
                  ...
                  <div className="flex justify-between items-center pt-2 border-t border-slate-100">
                    <span className="text-xs text-slate-600 font-bold">a.n. Dimas Anggara</span>
                    <button
              ...
              <ScrollReveal delay={300}>
                <div className="bg-white p-5 rounded-3xl border border-slate-200 text-left space-y-3 shadow-md">
                  ...
                  <div className="flex justify-between items-center pt-2 border-t border-slate-100">
                    <span className="text-xs text-slate-600 font-bold">a.n. Annisa Rahma</span>
                    <button
          ...
          <section className="px-6 py-12 text-center space-y-6 bg-slate-50/50">
            ...
            <ScrollReveal delay={200}>
              <div className="pt-4 border-t border-slate-200 space-y-1">
                ...
                <h3 className="text-3xl font-adea-forum text-slate-900 tracking-wider uppercase font-bold">Dimas &amp; Annisa</h3>
