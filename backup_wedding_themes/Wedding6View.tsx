...
export default function Wedding6View({
  ...
  const groomName = invitationData?.nickname || invitationData?.groom_name || "Rizky";
  ...
  const [comments, setComments] = useState<Array<{ name: string; attendance: string; pax: string; wish: string; date: string }>>([
    {
      ...
      attendance: "Hadir",
      pax: "2",
      wish: "Selamat untuk Amanda & Rizky! Semoga pernikahan ini selalu dipenuhi kasih dan kebahagiaan.",
    ...
    },
    {
      ...
      attendance: "Hadir",
      pax: "1",
      wish: "Happy Wedding Amanda & Rizky! Semoga rukun dan bahagia senantiasa sampai anak cucu.",
  ...
  const targetDate = new Date("2026-02-17T08:00:00").getTime();
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-[#FFFFFF] font-sans antialiased overflow-x-hidden selection:bg-white selection:text-black">
        ...
        >
          ...
          <div className="absolute inset-0 z-0">
            <Image
              ...
              fill
              className="object-cover object-center opacity-65 filter brightness-95"
              priority
            />
      ...
      {(isOpened || isClosingCover) && (
        ...
        <section id="home" className="relative min-h-screen flex flex-col items-center justify-end pb-8 pt-16 px-4 text-center border-b border-white/10 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              ...
              fill
              className="object-cover object-center opacity-60 filter brightness-95"
              priority
            />
            ...
            <div className="space-y-8 max-w-sm mx-auto flex flex-col items-center z-10 relative">
              ...
              <div className="space-y-6 text-center font-montserrat max-w-xs mx-auto">
                <div className="space-y-1 py-2 text-center">
                  <h4 className="font-cinzel text-xs font-bold text-white">Awal Bertemu</h4>
                  <p className="text-xs text-zinc-200 leading-relaxed font-light">
                    Pertemuan pertama kami yang sederhana menumbuhkan rasa saling mengerti dan benih-benih cinta yang tulus.
                  </p>
                </div>

                <div className="space-y-1 py-2 text-center">
                  <h4 className="font-cinzel text-xs font-bold text-white">Menjalin Hubungan</h4>
                  <p className="text-xs text-zinc-200 leading-relaxed font-light">
                    Seiring berjalannya waktu, komitmen kami semakin kuat untuk saling melengkapi dan berjalan bersama.
                  </p>
                </div>

                <div className="space-y-1 py-2 text-center">
                  <h4 className="font-cinzel text-xs font-bold text-white">Bertunangan</h4>
                  <p className="text-xs text-zinc-200 leading-relaxed font-light">
                    Di hadapan kedua keluarga besar, kami mengikrarkan niat suci untuk melangkah ke jenjang pernikahan.
                  </p>
                </div>

                <div className="space-y-1 py-2 text-center">
                  <h4 className="font-cinzel text-xs font-bold text-white">Hari Pernikahan</h4>
                  <p className="text-xs text-zinc-200 leading-relaxed font-light">
                    Hari bahagia tempat kami mengikat janji suci sehidup semati dalam iman, pengharapan, dan kasih.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* ======================================================== */}
        <section id="qrcode-section" className="relative min-h-[60vh] flex flex-col justify-center items-center py-16 px-6 border-b border-white/10 text-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              src="/indo_prewed_livestream_1_1785093423516.jpg"
          ...
          <ScrollReveal variant="zoom-in">
            <div className="bg-[#0A0A0A]/85 backdrop-blur-md rounded-3xl p-6 border border-white/20 shadow-2xl space-y-4 max-w-sm mx-auto z-10 relative">
              <div className="space-y-1">
                <span className="font-montserrat text-[10px] text-zinc-400 font-bold uppercase tracking-[0.25em]">PRESENSI DIGITAL</span>
                <h3 className="font-cinzel text-xl text-white font-bold tracking-widest uppercase">
                  QR Code Tamu Undangan
                </h3>
              </div>

              <div className="bg-white p-4 rounded-2xl inline-block shadow-xl border border-white/30">
                <img
              ...
              <div className="space-y-1 text-center">
                ...
                <p className="font-montserrat text-xs text-zinc-300 leading-relaxed font-light max-w-xs mx-auto">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {galleryPhotos.map((photo, idx) => (
                    <div
                      key={idx}
                      onClick={() => setSelectedImage(photo)}
                      className="relative col-span-1 h-36 rounded-2xl overflow-hidden border border-white/25 shadow-lg cursor-pointer group transition-all duration-300 hover:border-white/60 hover:shadow-2xl"
                    >
                      <Image
                        src={photo}
        ...
        <section id="gift" className="relative py-20 px-6 border-b border-white/10 text-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              src="/indo_prewed_gift_1_1785093433664.jpg"
              alt="Gift Background"
              fill
              className="object-cover object-center brightness-90"
            />
                ...
                <div className="space-y-6 pt-4 text-left">
                  ...
                  <div className="space-y-2 border-b border-white/10 pb-4">
                    <div className="flex items-center justify-between">
                      <span className="font-bold font-cinzel text-xs text-white">BANK BCA</span>
                      <Gift className="w-4 h-4 text-white" />
                    </div>
                    <div>
                      <p className="font-mono text-base font-bold text-white">0123 456 789</p>
                      <p className="font-montserrat text-xs text-zinc-300">a.n. Amanda Manopo</p>
                    </div>
                    <button
                    ...
                    >
                      ...
                      <span>{copiedBank === "bca" ? "TERSALIN!" : "SALIN NO. REKENING"}</span>
                    </button>
                  </div>
                  ...
                  <div className="space-y-2 pb-2">
                    <div className="flex items-center justify-between">
                      <span className="font-bold font-cinzel text-xs text-white">GOPAY / DIGITAL WALLET</span>
                      <Gift className="w-4 h-4 text-white" />
                    </div>
                    <div>
                      <p className="font-mono text-base font-bold text-white">0812 3456 7890</p>
                      <p className="font-montserrat text-xs text-zinc-300">a.n. Rizky Febrian</p>
                    </div>
                    <button
                      onClick={() => copyToClipboard("081234567890", "gopay")}
                      className="w-full py-2 border border-white/70 bg-transparent hover:bg-white hover:text-black text-white rounded-full text-[10px] font-cinzel tracking-wider transition-all flex items-center justify-center gap-2 cursor-pointer backdrop-blur-md"
                    >
                      {copiedBank === "gopay" ? <Check className="w-3.5 h-3.5" /> : <Copy className="w-3.5 h-3.5" />}
                      <span>{copiedBank === "gopay" ? "TERSALIN!" : "SALIN NOMOR GOPAY"}</span>
                    </button>
                  </div>
                </div>
              ) : (
        ...
        <section id="wishes" className="relative py-20 px-6 border-b border-white/10 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              src="/indo_prewed_rsvp_1_1785094172087.jpg"
              alt="RSVP Background"
              fill
              className="object-cover object-center brightness-90"
            />
                    ...
                    <div key={idx} className="p-3.5 border-b border-white/10 space-y-1 text-left">
                      <div className="flex items-center justify-between">
                        ...
                        <span className={`px-2.5 py-0.5 text-[9px] font-semibold rounded-full border ${
                          item.attendance === "Hadir" ? "border-emerald-400 text-emerald-300 bg-emerald-950/40" : "border-rose-400 text-rose-300 bg-rose-950/40"
                        }`}>
                          {item.attendance} ({item.pax} pax)
                        </span>
                      </div>
                      <p className="text-zinc-300 leading-relaxed font-light text-xs">{item.wish}</p>
