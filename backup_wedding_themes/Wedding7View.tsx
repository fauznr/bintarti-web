...
export default function Wedding7View({
  ...
  const storyList = [
    {
      ...
      date: "15 Juni 2021",
      desc: "Pertemuan pertama kami yang tidak disengaja di sebuah acara kampus. Berawal dari sapaan singkat yang menjadi awal dari kisah manis ini."
    },
    {
      title: "Memulai Komitmen",
      date: "10 Oktober 2022",
      desc: "Setelah melewati berbagai cerita bersama, kami memutuskan untuk saling berkomitmen dan berjalan beriringan menuju masa depan."
    },
    {
      title: "Momen Lamaran",
      date: "12 November 2025",
      desc: "Dengan restu kedua orang tua dan keluarga besar, kami mengikrarkan niat suci untuk melangkah ke jenjang pernikahan."
    },
    {
      title: "Hari Pernikahan",
      date: "01 Januari 2026",
      desc: "Hari yang kami nanti-nantikan untuk menyatukan dua hati dan dua keluarga dalam ikatan suci pernikahan yang diridhai Allah SWT."
    }
  ];
  ...
  return (
    <div className="relative min-h-screen bg-[#FAFBFB] text-[#2D3748] font-montserrat antialiased selection:bg-[#6a8f7f] selection:text-white overflow-x-hidden">
        ...
        >
          ...
          <div className="absolute inset-0 z-0 select-none overflow-hidden">
            <Image
              ...
              fill
              className="object-cover object-center brightness-95 scale-105 animate-pulse duration-[10000ms]"
              priority
            />
      ...
      {/* Floating Audio Disc Toggle Button */}
      {isOpened && (
        <button
          onClick={toggleAudio}
          className="fixed bottom-5 right-5 z-[900] p-3 rounded-full bg-white/90 border border-[#6a8f7f]/60 text-[#6a8f7f] shadow-2xl backdrop-blur-md hover:scale-110 transition-all cursor-pointer group"
          title="Toggle Music"
        >
          <Disc
            className={`w-6 h-6 ${isPlayingAudio ? "animate-spin duration-3000 text-[#6a8f7f]" : "text-zinc-400"}`}
          />
        </button>
      )}
      ...
      <div className="max-w-md mx-auto min-h-screen bg-[#FAFBFB] shadow-2xl relative border-x border-[#6a8f7f]/10 pb-8">
        ...
        {/* ======================================================== */}
        {/* SECTION 3: COUNTDOWN TIMER & SAVE THE DATE             */}
        {/* ======================================================== */}
        <section className="relative py-16 px-6 text-center space-y-8 bg-[#6a8f7f]">
          <ScrollReveal variant="fade-up">
            <div className="space-y-2">
            ...
            {/* Countdown Grid */}
            <div className="grid grid-cols-4 gap-2 pt-4 max-w-xs mx-auto">
              <div className="p-3 rounded-2xl bg-white border border-[#6a8f7f]/30 shadow-md text-center">
                <span className="font-cinzel text-xl font-bold text-[#6a8f7f] block">
                  {String(timeLeft.days).padStart(2, "0")}
                </span>
                <span className="font-montserrat text-[9px] text-[#718096] tracking-wider font-light uppercase">
                  Hari
                </span>
              </div>
              <div className="p-3 rounded-2xl bg-white border border-[#6a8f7f]/30 shadow-md text-center">
            ...
            <div className="pt-6">
              <a
                href="https://www.google.com/calendar/render?action=TEMPLATE&text=The+Wedding+of+Disa+%26+Trio&details=Acara+Pernikahan+Disa+%26+Trio&location=Pendopo+Papuri+Bandung&dates=20260101T010000Z%2F20260101T070000Z"
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border border-white bg-white hover:bg-white/90 text-[#6a8f7f] text-[10px] font-cinzel tracking-widest font-bold transition-all shadow-lg cursor-pointer"
              >
                <Calendar className="w-3.5 h-3.5" />
                <span>SIMPAN TANGGALNYA!</span>
              </a>
            </div>
          </ScrollReveal>
        </section>
        ...
        {/* ======================================================== */}
        <section id="event" className="relative py-16 px-6 text-center space-y-10 bg-[#FAFBFB]">
          <ScrollReveal variant="fade-up">
            <div className="space-y-2">
              <span className="font-cinzel text-[10px] text-[#6a8f7f] tracking-[0.3em] uppercase font-bold">
                SAVE THE
              ...
              <div className="h-0.5 w-12 bg-[#6a8f7f]/50 mx-auto my-2" />
              <p className="font-montserrat text-xs text-[#4A5568] leading-relaxed max-w-xs mx-auto font-light">
                Bergabunglah bersama kami menyaksikan sekaligus merayakan terbentuknya ikatan suci ini. Kami ingin Anda menjadi bagian dari Momen Istimewa kami.
              </p>
            </div>
          </ScrollReveal>
          ...
          {/* AKAD NIKAH CARD */}
          <ScrollReveal delay={200} variant="zoom-in">
            <div className="p-6 rounded-3xl bg-white border border-[#6a8f7f]/30 shadow-xl space-y-4 text-center">
              <div className="inline-block p-3 rounded-full bg-[#6a8f7f]/10 border border-[#6a8f7f]/30 text-[#6a8f7f]">
                <Heart className="w-5 h-5 fill-[#6a8f7f]" />
              </div>
              <h3 className="font-cinzel text-lg font-bold text-[#1A202C] tracking-widest uppercase">
                AKAD NIKAH
              </h3>
              <div className="space-y-1 text-xs text-[#4A5568] font-light">
                <p className="font-cinzel font-bold text-[#6a8f7f] tracking-wider text-sm">
                  MINGGU, 01 JANUARI 2026
                </p>
                <p className="flex items-center justify-center gap-1 text-[#718096]">
                  <Clock className="w-3.5 h-3.5 text-[#6a8f7f]" /> 08.00 WIB - Selesai
                </p>
              </div>
              <div className="pt-2 border-t border-[#6a8f7f]/20 space-y-1">
                <h4 className="font-cinzel text-sm font-bold text-[#1A202C]">
                  Pendopo Papuri
                </h4>
                <p className="font-montserrat text-[11px] text-[#718096] leading-relaxed font-light">
                  Jl. Soekarno Hatta No.785, Babakan Penghulu, Kec. Cinambo, Kota Bandung
                </p>
              </div>
              <a
                href="https://maps.google.com/?q=Pendopo+Papuri+Bandung"
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-[#6a8f7f] bg-white hover:bg-[#6a8f7f] hover:text-white text-[#6a8f7f] text-[9px] font-cinzel tracking-widest font-bold transition-all cursor-pointer shadow-sm"
              >
          ...
          {/* RESEPSI CARD */}
          <ScrollReveal delay={300} variant="zoom-in">
            <div className="p-6 rounded-3xl bg-white border border-[#6a8f7f]/30 shadow-xl space-y-4 text-center">
              <div className="inline-block p-3 rounded-full bg-[#6a8f7f]/10 border border-[#6a8f7f]/30 text-[#6a8f7f]">
              ...
              <div className="space-y-1 text-xs text-[#4A5568] font-light">
                ...
                <p className="flex items-center justify-center gap-1 text-[#718096]">
                  <Clock className="w-3.5 h-3.5 text-[#6a8f7f]" /> 11.00 - 14.00 WIB
                </p>
              </div>
              <div className="pt-2 border-t border-[#6a8f7f]/20 space-y-1">
                <h4 className="font-cinzel text-sm font-bold text-[#1A202C]">
            ...
            <div className="grid grid-cols-3 gap-2 pt-3">
              {galleryPhotos.map((photo, idx) => (
                <div
                  key={idx}
                  onClick={() => setSelectedImage(photo)}
                  className="relative col-span-1 h-36 rounded-2xl overflow-hidden cursor-pointer group border border-white/20 shadow-md hover:shadow-xl transition-all duration-300"
                >
                  <Image
                    src={photo}
      ...
      {isOpened && (
        <div className="fixed bottom-6 right-6 z-[990] flex flex-col items-center gap-3">
          <button
            ...
            className="w-12 h-12 rounded-full border border-[#6a8f7f]/50 bg-white text-[#6a8f7f] shadow-2xl flex items-center justify-center backdrop-blur-md hover:scale-110 active:scale-95 transition-all cursor-pointer group"
            aria-label="QR Code Presensi"
            title="QR Code Presensi Tamu"
          >
            <QrCode className="w-5 h-5 text-[#6a8f7f] group-hover:text-[#1A202C] transition-colors" />
          </button>
