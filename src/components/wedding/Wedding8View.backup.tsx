...
const CrumpleLines = () => (
  ...
  >
    <line x1="15%" y1="0" x2="22%" y2="100%" stroke="#5D3A1A" strokeWidth="0.7" />
    <line x1="38%" y1="0" x2="31%" y2="100%" stroke="#5D3A1A" strokeWidth="0.5" />
    <line x1="72%" y1="0" x2="68%" y2="100%" stroke="#5D3A1A" strokeWidth="0.6" />
    <line x1="88%" y1="0" x2="94%" y2="100%" stroke="#5D3A1A" strokeWidth="0.4" />
    <line x1="0" y1="18%" x2="100%" y2="24%" stroke="#5D3A1A" strokeWidth="0.5" />
    <line x1="0" y1="55%" x2="100%" y2="48%" stroke="#5D3A1A" strokeWidth="0.6" />
    <line x1="0" y1="82%" x2="100%" y2="78%" stroke="#5D3A1A" strokeWidth="0.4" />
    {/* Diagonal crumple marks */}
    <line x1="0" y1="0" x2="45%" y2="62%" stroke="#5D3A1A" strokeWidth="0.3" />
    <line x1="100%" y1="0" x2="55%" y2="72%" stroke="#5D3A1A" strokeWidth="0.3" />
    <line x1="0" y1="100%" x2="55%" y2="30%" stroke="#5D3A1A" strokeWidth="0.25" />
    <line x1="100%" y1="100%" x2="48%" y2="25%" stroke="#5D3A1A" strokeWidth="0.25" />
  </svg>
);

// ─── Torn Edge SVG ────────────────────────────────────────────────────────────
const TornEdgeTop = ({ color = "#F5EDD6" }: { color?: string }) => (
  <svg viewBox="0 0 400 28" preserveAspectRatio="none" className="w-full block" style={{ height: 28 }}>
    <path
      d="M0,0 L0,14 C10,18 18,8 28,13 C38,18 46,6 58,10 C70,14 80,2 92,6 C104,10 114,0 126,4 C138,8 148,16 160,12 C172,8 182,2 194,6 C206,10 216,18 228,14 C240,10 250,4 262,8 C274,12 284,2 296,6 C308,10 318,20 330,16 C342,12 352,4 364,8 C376,12 388,20 400,16 L400,0 Z"
      fill={color}
    />
  </svg>
);

const TornEdgeBottom = ({ color = "#F5EDD6" }: { color?: string }) => (
  <svg viewBox="0 0 400 28" preserveAspectRatio="none" className="w-full block" style={{ height: 28 }}>
    <path
      d="M0,28 L0,14 C12,10 22,20 34,16 C46,12 56,22 68,18 C80,14 90,24 102,20 C114,16 124,6 136,10 C148,14 158,22 170,17 C182,12 192,4 204,8 C216,12 226,20 238,15 C250,10 260,2 272,6 C284,10 294,18 306,14 C318,10 328,2 340,6 C352,10 362,20 374,16 C386,12 396,6 400,10 L400,28 Z"
      fill={color}
    />
  </svg>
);
...
// ─── Main Component ───────────────────────────────────────────────────────────
export default function Wedding8View({ invitationData, guestName, themeId }: Props) {
  // ── State ──
  ...
  if (!isOpened) {
    return (
      ...
      >
          ...
          <div className="relative z-10 space-y-5">
            ...
            <div className="py-3 space-y-1">
              <div
                ...
                style={{ color: "#5C2E00", fontFamily: "Georgia, serif" }}
              >
                {groomShort}
              </div>
        ...
        <div className="absolute bottom-8 left-8 w-6 h-4 opacity-30 rotate-12" style={{ background: "#EDE0B5", borderRadius: "1px" }} />
        <div className="absolute top-16 right-10 w-4 h-6 opacity-20 -rotate-6" style={{ background: "#EDE0B5", borderRadius: "1px" }} />
        <div className="absolute bottom-20 right-6 w-3 h-3 opacity-25 rotate-45" style={{ background: "#EDE0B5", borderRadius: "1px" }} />
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      {musicUrl && (
        <button
          onClick={toggleAudio}
          className="fixed bottom-5 right-5 z-[900] w-12 h-12 rounded-full flex items-center justify-center shadow-xl cursor-pointer transition-all active:scale-95"
          style={{
            background: "linear-gradient(135deg, #3D1F08, #5C2E00)",
          ...
          title="Toggle Musik"
        >
          {isPlaying ? <Music className="w-5 h-5 text-amber-200" /> : <MicOff className="w-5 h-5 text-amber-300/70" />}
        </button>
      )}
      ...
      <section className="relative min-h-screen flex flex-col justify-between items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          {/* Aged paper overlay on photo */}
          <div
            className="absolute inset-0"
            style={{
              background: "linear-gradient(to bottom, rgba(245,237,214,0.55) 0%, rgba(245,237,214,0.2) 40%, rgba(245,237,214,0.65) 85%, #F5EDD6 100%)",
            }}
          />
          {/* Sepia tint */}
        ...
        {/* Crumple effect lines on hero */}
        <div className="absolute inset-0 z-[2] pointer-events-none">
          <CrumpleLines />
        </div>

        {/* Top header */}
        <div className="relative z-10 pt-12 text-center px-6 space-y-1">
          <div
            className="inline-flex items-center gap-1.5 px-3 py-1 border-2 rounded-sm"
        ...
        <div className="relative z-10 text-center px-6 space-y-4">
          <p className="text-xs font-bold tracking-[0.3em] text-amber-900/60 uppercase">
            The Wedding Of
          </p>
          <div
          ...
          <div className="py-2">
            ...
            <p className="text-xs font-bold tracking-widest text-amber-900/50 uppercase pt-1">
              {akadDate ? new Date(akadDate).toLocaleDateString("id-ID", { day: "numeric", month: "long", year: "numeric" }) : "20 September 2025"}
            </p>
          </div>
        </div>
      ...
      {/* ══════════════════════════════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════════════════════════════ */}
      <section className="relative py-16 px-6" style={{ background: "#F5EDD6" }}>
        <PaperTexture />
        <CrumpleLines />
        ...
        <Reveal className="relative z-10 space-y-8">
          ...
          >
            ...
            <div className="relative z-10 flex gap-4 items-start">
              ...
              <div className="flex-1 space-y-1">
                <p className="text-[10px] font-bold text-amber-800/60 uppercase tracking-widest">Mempelai Pria</p>
                <h3 className="text-xl font-black text-amber-950">{groom}</h3>
                <p className="text-xs text-amber-800/70 italic">Putra dari Bapak & Ibu Suharto</p>
                <div className="flex gap-1 mt-1">
                  {[...Array(5)].map((_, i) => (
                    <Heart key={i} className="w-2.5 h-2.5 fill-amber-800/40 text-amber-800/40" />
                  ))}
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-center">
            <div
              className="w-12 h-12 rounded-full flex items-center justify-center font-black text-2xl text-amber-200 shadow-lg"
          ...
          >
            <PaperTexture />
            <div className="relative z-10 flex gap-4 items-start flex-row-reverse">
              <div
                className="w-20 h-24 flex-shrink-0 overflow-hidden"
                style={{
                  border: "3px solid rgba(139,90,43,0.3)",
              ...
              <div className="flex-1 space-y-1 text-right">
                <p className="text-[10px] font-bold text-amber-800/60 uppercase tracking-widest">Mempelai Wanita</p>
                <h3 className="text-xl font-black text-amber-950">{bride}</h3>
                <p className="text-xs text-amber-800/70 italic">Putri dari Bapak & Ibu Wardhana</p>
      ...
      {/* ══════════════════════════════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════════════════════════════ */}
      <section className="relative" style={{ background: "#2C1A0E" }}>
        ...
        <div className="py-16 px-6 space-y-8">
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center gap-2 text-amber-950">
                    ...
                    <span className="text-sm font-bold">
                      {akadDate ? new Date(akadDate).toLocaleDateString("id-ID", { weekday: "long", day: "numeric", month: "long", year: "numeric" }) : "Sabtu, 20 September 2025"}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-amber-950">
              ...
              <div className="relative z-10 space-y-3">
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center gap-2 text-amber-950">
                    <Calendar className="w-4 h-4 text-amber-800/70 flex-shrink-0" />
                    <span className="text-sm font-bold">
                      {resepsiDate ? new Date(resepsiDate).toLocaleDateString("id-ID", { weekday: "long", day: "numeric", month: "long", year: "numeric" }) : "Sabtu, 20 September 2025"}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-amber-950">
                    <Clock className="w-4 h-4 text-amber-800/70 flex-shrink-0" />
          ...
          {/* Countdown */}
          <Reveal delay={300} className="relative z-10 text-center space-y-4">
      ...
      <section className="relative py-16 px-6" style={{ background: "#F5EDD6" }}>
        ...
        <Reveal className="relative z-10 space-y-8">
          ...
          <div className="relative space-y-6 pl-6">
            <div className="absolute left-2.5 top-2 bottom-2 w-px" style={{ background: "linear-gradient(to bottom, #8B4513, transparent)" }} />

            {[
              { year: "2018", title: "Pertama Bertemu", desc: "Takdir mempertemukan kami di sebuah acara yang tak terduga. Senyum pertamamu tak pernah terlupakan." },
              { year: "2020", title: "Mulai Bersama", desc: "Dengan memberanikan diri, kami memulai perjalanan baru. Setiap langkah terasa lebih ringan berdua." },
              { year: "2023", title: "Lamaran", desc: "Di bawah langit sore yang jingga, sebuah janji diucapkan. Sebuah 'iya' yang mengubah segalanya." },
              { year: "2025", title: "Hari Bahagia", desc: "Hari yang dinantikan. Bersama, kami melangkah menuju babak baru kehidupan yang penuh berkah." },
            ].map((item, i) => (
              <Reveal key={i} delay={i * 100}>
                <div className="relative flex gap-4 items-start">
                  <div
                    className="absolute -left-6 w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0"
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <span
                        className="text-[9px] font-black px-1.5 py-0.5 text-amber-100"
              ...
              <div className="absolute bottom-3 inset-x-0 flex justify-center gap-1.5 z-10">
                {galleryPhotos.map((_, i) => (
                  <button
                    ...
                    className={`transition-all rounded-full ${i === currentSlide ? "w-5 h-1.5 bg-amber-200" : "w-1.5 h-1.5 bg-amber-200/40"}`}
                  />
                ))}
              </div>
            </div>
              ...
              {galleryPhotos.map((photo, idx) => (
                <div
                  ...
                  style={{
                    ...
                    boxShadow: "-2px -1px 0 rgba(0,0,0,0.2), 2px 3px 8px rgba(0,0,0,0.4)",
                    transform: `rotate(${idx % 2 === 0 ? (idx % 4 === 0 ? "-2.5deg" : "1.5deg") : (idx % 3 === 0 ? "2deg" : "-1deg")})`,
                  }}
                >
                  ...
                  <p
                    className="text-center text-[8px] font-bold mt-1.5 truncate"
          ...
          {[
            ...
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #F0E3BE, #F7EDD4)",
                border: "1px solid rgba(139,90,43,0.25)",
                boxShadow: i % 2 === 0 ? "-2px -1px 0 rgba(0,0,0,0.08), 2px 2px 8px rgba(0,0,0,0.12)" : "2px -1px 0 rgba(0,0,0,0.08), -2px 2px 8px rgba(0,0,0,0.12)",
                transform: i % 2 === 0 ? "rotate(0.4deg)" : "rotate(-0.4deg)",
              }}
            >
              <PaperTexture />
              ...
              <div className="relative z-10 space-y-3">
                ...
                <textarea
                  ...
                  style={{
                    ...
                    fontFamily: "Georgia, serif",
                    lineHeight: "1.8",
                    backgroundImage: "repeating-linear-gradient(transparent, transparent 26px, rgba(139,90,43,0.12) 26px, rgba(139,90,43,0.12) 27px)",
                  }}
                />
                <button
                  onClick={handleWish}
                ...
                >
                  {wishSent ? <><CheckCircle2 className="w-3.5 h-3.5" /> Terkirim!</> : <><Send className="w-3.5 h-3.5" /> Kirim Ucapan</>}
                </button>
              </div>
            </div>
          </Reveal>
