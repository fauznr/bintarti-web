const fs = require('fs');
const lines = fs.readFileSync('src/app/sandbox-tema/[id]/recovered_page.tsx', 'utf8').replace(/\r\n/g, '\n').split('\n');
...
console.log('RECOVERED FILE: If:', foundIf, 'Css:', foundCss, 'Comment:', foundComment);
